...
import AuthImagePattern from "../components/authimagepattern.components";
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex flex-col items-center gap-2 group">
                            <div
                                className="w-12 h-12 rounded-xl bg-transparent flex items-center justify-center group-hover:scale-150 duration-1000
                            transition-transform"
                            >
                                <img src="/chat_522914.png" />
                            </div>
